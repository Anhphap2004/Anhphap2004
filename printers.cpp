...
public:
    ...
    void xuatThongTin()
    {
        ...
        cout << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << setw(7) << "|"
             << setw(7) << tocDo << setw(7) << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(8) << "|\n";
        cout << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|\n";
        ofstream outputFile("output.txt", ios::app);
        if (outputFile.is_open())
        {
            outputFile << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << "|" << setw(7) << tocDo
                       << setw(7) << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(8) << "|\n";
            outputFile << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|\n";
    ...
    void xuatbangtimkiem()
    {
        ...
        if (outputFile.is_open())
        {
            ...
            outputFile << "    ___________________________________________________________________________________________________\n";
...
public:
    ...
    void xuatThongTin()
    {
        ...
        cout << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << setw(7) << "|" << setw(7) << tocDo
             << setw(7) << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(7) << "|" << setw(7) << dpi << setw(8) << "|\n";
        cout << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|_____________|\n";

        ofstream outputFile("output.txt", ios::app);
        if (outputFile.is_open())
        {

            outputFile << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << setw(7) << "|" << setw(7) << tocDo
                       << setw(7) << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(7) << "|" << setw(7) << dpi << setw(8) << "|\n";
            outputFile << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|_____________|\n";
    ...
    void xuatbangtimkiem()
    {
        ...
        if (outputFile.is_open())
        {
            ...
            outputFile << "    _________________________________________________________________________________________________________________\n";
...
public:
    ...
    void xuatThongTin()
    {
        cout << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << setw(7) << "|" << setw(7) << tocDo << setw(7)
             << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(7) << "|" << setw(7)
             << dpi << setw(7) << "|" << setw(9) << soMauInDuoc << setw(12) << "|\n";
        cout << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|_____________|___________________|\n";

        ofstream outputFile("output.txt", ios::app);
        if (outputFile.is_open())
        {

            outputFile << "   |" << setw(20) << soHieuMayIn << setw(10) << "|" << setw(7) << mauSac << setw(7) << setw(7) << "|" << setw(7) << tocDo << setw(7)
                       << "|" << setw(7) << cuongDo << setw(7) << "|" << setw(7) << boNho << setw(7) << "|" << setw(7) << soLuong << setw(7) << "|" << setw(7)
                       << dpi << setw(7) << "|" << setw(9) << soMauInDuoc << setw(12) << "|\n";
            outputFile << "   |_____________________________|_____________|_____________|_____________|_____________|_____________|_____________|___________________|\n";
    ...
    void xuatbangtimkiem()
    {
        ...
        if (outputFile.is_open())
        {
            ...
            outputFile << "    _____________________________________________________________________________________________________________________________________\n";
        ...
        for (MayIn *mayIn : danhSachMayIn)
        {
            if (mayIn->getSoHieuMayIn() == soHieu && mayIn->getMausac() == mauSac)
            {
                if (mayIn->getSoLuong() >= soLuong)
                {
                    ...
                    cout << "   |_____________________________|_____________|_____________|\n";
                    cout << "   |" << setw(20) << soHieu << setw(10) << right << "|" << setw(7) << mauSac << setw(7) << right << "|" << setw(6) << mayIn->getSoLuong() << setw(9) << right << "|\n";
                    cout << "   |_____________________________|_____________|_____________|\n";
                    cout << endl;
                    ofstream outputFile("output.txt", ios::app);
                    if (outputFile.is_open())
                    {
                        outputFile << endl;
                        outputFile << "~~~~~~~~~~  Thong TIN MAY IN  ~~~~~~~~~~ " << endl;
                        outputFile << "    _________________________________________________________\n";
                        outputFile << "   |       So hieu may in        |   Mau Sac   |   So luong  |\n";
                        outputFile << "   |_____________________________|_____________|_____________|\n";
                        outputFile << "   |" << setw(20) << soHieu << setw(10) << right << "|" << setw(7) << mauSac << setw(7) << right << "|" << setw(6) << mayIn->getSoLuong() << setw(9) << right << "|\n";
                        outputFile << "   |_____________________________|_____________|_____________|\n";
                        outputFile << endl;
                    }
                    else
    ...
    void Hoadonxuat()
    {
        ...
        for (MayIn *mayIn : danhSachMayIn)
        {
            ...
            if (mayIn->getSoHieuMayIn() == soHieu && mayIn->getSoLuong() >= soLuong)
            {
                ...
                cout << "|          |______|___________________|_____________________________|___________________|___________________|___________________|    |\n";
                ...
                for (int i = 1; i <= donhang; i++)
                {
                    ...
                    cout << "|          |" << setw(4) << STT << setw(3) << "|" << left << setw(17) << tenhanghoa << setw(3) << right << "|" << setw(20) << left << soHieu
                         << setw(10) << right << "|" << setw(12) << left << soLuong << setw(8) << right << "|" << setw(12) << DonGia << left << setw(8) << right << "|" << setw(12) << left << thanhtien << setw(8) << right << "|" << setw(6) << right
                         << "|\n";
                    cout << "|          |______|___________________|_____________________________|___________________|___________________|___________________|    |\n";
                }
                cout << "|                                                                                       |    TONG TIEN      |" << setw(17) << left << tongtien << setw(3) << right << "|" << setw(6) << "|\n";
                cout << "|                                                                                       |___________________|___________________|    |\n";
                cout << "|      PAYMENT METHOD :                                                                 |    TAX(%)         |" << setw(17) << left << tienthue << setw(3) << right << "|" << setw(6) << "|\n";
                cout << "|      Bank Name      : ANHH PHAPP                                                      |___________________|___________________|    |\n";
                cout << "|      BANK           : BIDV                                                            |  TONG THANH TOAN  |" << setw(17) << left << tongthanhtoan << setw(3) << right << "|" << setw(6) << "|\n";
                ...
                {
                	outputFile <<endl;
                    outputFile << "Hoa don xuat may in la" << endl;
                    outputFile << " ____________________________________________________________________________________________________________________________________\n";
                    outputFile << "|====================================================== HOA DON XUAT =============================================================== |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|                                                                                             SO Hoa Don: " << left << masohoadon << setw(23) << right << "|\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "| Don Vi          : CONG TY CO PHAN THUONG MAI MAY IN SO MOT THE GIOI                                                                |\n";
                    outputFile << "| Ma So Thue      : 123456789                                                                                                        |\n";
                    outputFile << "| Dia Chi         : 309 - VIET NAM - TP. TRAI DAT                                                                                    |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "| Khach Hang      : " << setw(100) << left << TenKH << setw(15) << right << "|\n";
                    outputFile << "| Dia Chi Khach   : " << setw(100) << left << DiachiKH << setw(15) << right << "|\n";
                    outputFile << "| So dien thoai   : " << setw(100) << left << SDTKH << setw(15) << right << "|\n";
                    outputFile << "| Ma Khach hang   : " << setw(100) << left << CODEKH << setw(15) << right << "|\n";
                    outputFile << "| Thanh Toan      : " << setw(100) << left << payments << setw(15) << right << "|\n";
                    outputFile << "| Ngay/Thang/Nam  : " << setw(100) << left << DATE << setw(15) << right << "|\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|           ____________________________________________________________________________________________________________________     |\n";
                    outputFile << "|          |  STT |    Ten Hang Hoa   |           So Hieu           |  So Luong         |     Don Gia       |   Thanh Tien      |    |\n";
                    outputFile << "|          |______|___________________|_____________________________|___________________|___________________|___________________|    |\n";
                    ...
                    for (int i = 1; i <= donhang; i++)
                    {
                        ...
                        outputFile << "|          |" << setw(4) << STT << setw(3) << "|" << left << setw(17) << tenhanghoa << setw(3) << right << "|" << setw(20) << left << soHieu
                                   << setw(10) << right << "|" << setw(12) << left << soLuong << setw(8) << right << "|" << setw(12) << DonGia << left << setw(8) << right << "|" << setw(12) << left << thanhtien << setw(8) << right << "|" << setw(6) << right
                                   << "|\n";
                        outputFile << "|          |______|___________________|_____________________________|___________________|___________________|___________________|    |\n";
                    }
                    outputFile << "|                                                                                       |    TONG TIEN      |" << setw(17) << left << tongtien << setw(3) << right << "|" << setw(6) << "|\n";
                    outputFile << "|                                                                                       |___________________|___________________|    |\n";
                    outputFile << "|      PAYMENT METHOD :                                                                 |    TAX(%)         |" << setw(17) << left << tienthue << setw(3) << right << "|" << setw(6) << "|\n";
                    outputFile << "|      Bank Name      : ANHH PHAPP                                                      |___________________|___________________|    |\n";
                    outputFile << "|      BANK           : BIDV                                                            |  TONG THANH TOAN  |" << setw(17) << left << tongthanhtoan << setw(3) << right << "|" << setw(6) << "|\n";
                    outputFile << "|      ACCOUNT        : 0339573127                                                      |___________________|___________________|    |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|      THANK YOU FOR PURCHASE ^^                                                                                                     |\n";
                    outputFile << "|____________________________________________________________________________________________________________________________________|\n";
                }
                else
                {
    ...
    void Hoadonnhap()
    {
        ...
        for (MayIn *mayIn : danhSachMayIn)
        {
            ...
            if (mayIn->getSoHieuMayIn() == soHieu)
            {
                ...
                if (outputFile.is_open())
                {
                    outputFile << "Hoa don nhap may in la" << endl;
                    outputFile << " ____________________________________________________________________________________________________________________________________\n";
                    outputFile << "|====================================================== HOA DON NHAP =============================================================== |\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "|                                                                                             SO Hoa Don: " << left << masohoadon << setw(23) << right << "|\n";
                    outputFile << "|                                                                                                                                    |\n";
                    outputFile << "| Don Vi          : CONG TY CO PHAN THUONG MAI MAY IN SO MOT THE GIOI                                                                |\n";
